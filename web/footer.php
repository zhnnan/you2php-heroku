...
?>
 ...
 <footer class="p-2">
        ...
        <p  class="text-white  m-1 p-1 h6">
			<a href="<?php echo WEB_PROXY ?>/proxy/http://truth.atspace.eu/" target="_blank" class="text-white ml-2">我的博客</a> 
			<a href="<?php echo WEB_PROXY ?>" target="_blank" class="text-white ml-2">Web代理</a> 
